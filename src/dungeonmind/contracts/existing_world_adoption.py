...
from .contribution import GraphContribution
from .evidence import SourceArtifactV2, SourceRevision
from .identity import IdentityDecisionRecord
...
def existing_world_adoption_bundle_canonical_bytes(
    ...
    """Serialize one bundle as UTF-8 canonical JSON with a trailing newline.
