...
**PR / branch / head:** [PR #18](https://github.com/Drakosfire/DungeonMind/pull/18) on `timeline/ft1a-revision-pinned-fictional-time-query` (use PR head SHA; do not treat this line as a frozen tip).
